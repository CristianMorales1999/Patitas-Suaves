...
<head>
    ...
    <link rel="stylesheet" href="style-cambiar-pass.css">
...
<body>
    ...
    <section class="formulario">
        <div class="container">
            ...
            <div class="form">
                <form action="php/actualizacion_password.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div>
                            <div>
                                <select class="select-order" name="edit" id="edit" onchange="redirectToPage()">
                                    ...
                                    <option value="ver-perfil.php">Perfil</option>
                    ...
                    <div class="input-group">
                        <div class="input-box">
                            <label for="pass__now">Contraseña Actual</label>
                            <input name="password_actual" type="password" minlength="8" required>
                        </div>
                    </div>
                    <div class="input-group">
                        <div class="input-box">
                            <label for="new__pass">Nueva Contraseña</label>
                            <input name="password_nuevo" type="password" minlength="8" required>
                        </div>
                    </div>

                    <div class="input-group">
                        <div class="input-box">
                            <label for="check-new__pass">Confirmar Nueva Contraseña</label>
                            <input name="password_nuevo_confirmado" type="password" minlength="8" required>
                        </div>
                    </div>
