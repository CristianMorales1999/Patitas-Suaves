...
<head>
    ...
    <link rel="stylesheet" href="style-ver-perfil.css">
                ...
                <form action="#">
                    ...
                    <div class="input-group">
                        <div class="input-box">
                            ...
                            <input type="text" value="<?php echo $_SESSION['apellidos'];?>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="input-group">
                        <div class="input-box">
                            ...
                            <input type="text" value="<?php echo $_SESSION['usuario'];?>" readonly>
                        </div>
                    </div>
                    <div class="input-group">
                        <div class="input-box">
                            <label for="email">Correo Electrónico</label>
                            <input type="email" value="<?php echo $_SESSION['correo'];?>" readonly>
                        </div>
                    </div>
