<?php
    ...
    $consultaFechasUnicas="SELECT DISTINCT fechaDeRegistro FROM mascota ORDER BY fechaDeRegistro";
    ...
    if(mysqli_num_rows($resultado)>0){//Si la mascota ya existe
        ...
        while($fila=$resultado->fetch_assoc()){//Mientras hallan filas del resultado de la consulta
            ...
            $consultaCantidadUsuarios="SELECT COUNT(*) AS cantidad FROM mascota WHERE fechaDeRegistro='$fechaActual'";
